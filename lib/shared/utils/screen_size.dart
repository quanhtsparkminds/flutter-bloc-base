...
class Screens {
  ...
  static Size appbarHeight(BuildContext context, {double? sizePlush}) {
    return Size.fromHeight(Screens.resizeFitDevice(
        context, sizePlush ?? AppBar().preferredSize.height + 72));
  }
