...
class SecureStorageHelper {
  ...
  Future<void> clearSecureStorageOnReinstall() async {
    MyLogger.d(
        'has run app before --${SPref.instance.getBool(StorageKeys.hasRunBefore)}');
    if (SPref.instance.getBool(StorageKeys.hasRunBefore) == true) {
      return;
    } else {
      await _box.deleteAll();
      SPref.instance.setBool(StorageKeys.hasRunBefore, true);
    }
  }
